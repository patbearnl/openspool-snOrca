...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("snOrca OpenSpool is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("snOrca OpenSpool is based on Snapmaker Orca / OrcaSlicer"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // version
    {
        ...
        const auto version_string = wxString::FromUTF8(SLIC3R_APP_NAME) + " " + std::string(Snapmaker_VERSION);
        wxStaticText* version = new wxStaticText(this, wxID_ANY, version_string, wxDefaultPosition, wxDefaultSize);
        wxStaticText* bs_version = new wxStaticText(this, wxID_ANY, wxString::Format("Based on Snapmaker Orca %s", std::string(Snapmaker_VERSION)), wxDefaultPosition, wxDefaultSize);
...
// #endif
    ...
    // snOrca OpenSpool
    text_list.push_back(_L("Note: The firmware version of Snapmaker U1 should be no less than") + " " + std::string(MIN_FIRM_VER));
    text_list.push_back(_L("snOrca OpenSpool is an unofficial community fork of Snapmaker Orca."));
    text_list.push_back(_L("It adds OpenSpool tag support for showing spools as Machine Filament entries (per toolhead, with color)."));
    text_list.push_back(_L("OpenSpool protocol: https://github.com/OpenSpool/openspool"));
    text_list.push_back(_L("Snapmaker Orca is forked from OrcaSlicer by SoftFever."));
    ...
    text_list.push_back(_L("This fork integrates OpenSpool support; see the project repository for details and credits."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright © 2024-2026 Snapmaker and contributors.", wxDefaultPosition, wxDefaultSize);
